...
document.documentElement.style.setProperty('--tg-theme-bg-color', tg.themeParams.bgColor || '#ffffff');
document.documentElement.style.setProperty('--tg-theme-text-color', tg.themeParams.textColor || '#000000');
document.documentElement.style.setProperty('--tg-theme-button-color', tg.themeParams.buttonColor || '#3390ec');
document.documentElement.style.setProperty('--tg-theme-button-text-color', tg.themeParams.buttonTextColor || '#ffffff');
document.documentElement.style.setProperty('--tg-theme-secondary-bg-color', tg.themeParams.secondaryBgColor || '#f4f4f5');
